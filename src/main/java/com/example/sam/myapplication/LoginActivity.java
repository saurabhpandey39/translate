...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("saurabh","LoginActivity onCreate()");
    ...
    private void store() {
        Log.d("saurabh"," LoginActivity store()");
        ...
        if(mPasswordView.getText().toString().equals("")) {
            Toast.makeText(this, "enter passwd", Toast.LENGTH_LONG).show();
            return;
        }
        dbController.insert(mEmailView.getText().toString(), mPasswordView.getText().toString());
    }

    private void show() {
        Log.d("saurabh","LoginActivity show()");
